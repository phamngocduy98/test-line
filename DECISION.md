...
`merge_output_specs.py` performs a separate compaction pass over solver output.
Its implemented behavior and planned smart-merge decisions are documented in
